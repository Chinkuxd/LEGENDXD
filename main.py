...
<body>
  <header class="header mt-4">
    <h1 class="mb-3">
            MADE BY CHINKU 
  <h1 class="mb-3">  MOUNTAIN DEW
  <h1 class="mb-3"> HATER KI MKC  >3:)
    <h1 class="mt-3"> CHINKU xD ON FIRE ❤️  </h1>
  </header>
  ...
  <footer class="footer">
    <p>&copy; Developed by Chinku xD 2024. All Rights Reserved.</p>
